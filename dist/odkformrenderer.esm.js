...
var ConnectedDate =
/*#__PURE__*/
connect(mapStateToProps$2, mapDispatchToProps$2)(KbDate);
...
/*#__PURE__*/
connect(mapStateToProps$3, mapDispatchToProps$3)(DateTime);
...
/*#__PURE__*/
connect(mapStateToProps$4, mapDispatchToProps$4)(Decimal);
...
/*#__PURE__*/
connect(mapStateToProps$5, mapDispatchToProps$5)(Integer);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return createElement(FormGroup, null, createElement(Label, null, fieldLabel), isRequired && createElement(Label, null, REQUIRED_SYMBOL), createElement(FormText, null, fieldHint), isRequiredViolated && createElement(Label, null, REQUIRED_FIELD_MSG), isConstraintViolated && createElement(Label, null, constraintLabel));
    } else {
      if (fieldValue != null) {
...
var ConnectedNote =
/*#__PURE__*/
connect(mapStateToProps$6, mapDispatchToProps$6)(Note);
...
var ConnectedPhoto =
/*#__PURE__*/
connect(mapStateToProps$7, mapDispatchToProps$7)(Photo);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return createElement(FormGroup, null, createElement(Label, null, fieldLabel), isRequired && createElement(Label, null, REQUIRED_SYMBOL), createElement(Select, {
        isMulti: true,
        name: fieldElement.name,
        options: options,
...
/*#__PURE__*/
connect(mapStateToProps$8, mapDispatchToProps$8)(SelectAllDropDown);
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      if (resultOptions.length > 0) {
        ...
        return createElement(FormGroup, null, createElement(Label, null, fieldLabel), isRequired && createElement(Label, null, REQUIRED_SYMBOL), resultOptions.map(function (elem, index) {
          return createElement("div", {
            key: index,
            className: "col-md-12"
          }, createElement(Input, {
        ...
        if (fieldElement.children) {
          return createElement(FormGroup, null, createElement(Label, null, fieldLabel), isRequired && createElement(Label, null, REQUIRED_SYMBOL), fieldElement.children.map(function (elem, index) {
            return createElement("div", {
              key: index,
              className: "col-md-12"
            }, createElement(Input, {
...
/*#__PURE__*/
connect(mapStateToProps$9, mapDispatchToProps$9)(SelectAllRadio);
...
/*#__PURE__*/
connect(mapStateToProps$a, mapDispatchToProps$a)(SelectOneDropDown);
...
/*#__PURE__*/
connect(mapStateToProps$b, mapDispatchToProps$b)(SelectOneRadio);
...
var ConnectedText =
/*#__PURE__*/
connect(mapStateToProps$c, mapDispatchToProps$c)(Text);
...
var ConnectedApp =
/*#__PURE__*/
connect(mapStateToProps$d, mapDispatchToProps$d)(App);
