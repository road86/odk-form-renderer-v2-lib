...
declare class Text extends React.Component<GPSProps, GPSState> {
...
declare const ConnectedText: import("react-redux").ConnectedComponent<typeof Text, Pick<GPSProps, "fieldElement" | "fieldParentTreeName" | "defaultLanguage"> & ParentProps>;
