...
declare class Audio extends React.Component<FileProps> {
...
declare const ConnectedAudio: import("react-redux").ConnectedComponent<typeof Audio, Pick<FileProps, "fieldElement" | "fieldParentTreeName" | "defaultLanguage"> & ParentProps>;
