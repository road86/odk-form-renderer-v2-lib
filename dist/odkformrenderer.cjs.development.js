...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(reactstrap.Alert, {
      color: color,
      isOpen: isOpen,
      toggle: handleToggle
    }, React.createElement("h4", {
      className: "alert-heading"
    }, headerText), React.createElement("p", null, bodyText));
  };
...
function Group(props) {
  ...
  if (isComponentRender && (fieldElement.control && fieldElement.control.bodyless ? fieldElement.control.bodyless === false : true)) {
    ...
    }, React.createElement(Typography, null, fieldLabel)), React.createElement(core.AccordionDetails, {
      className: classNames.backgroundProp
    }, React.createElement(reactstrap.FormGroup, {
      className: classNames.borderProp
    }, fieldElement.children && React.createElement(ConnectedGroupTypeEvaluator, {
      choices: choices,
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement(reactstrap.FormGroup, {
        className: 'groupBody'
      }, React.createElement(reactstrap.Label, null, fieldLabel), fieldValue && // tslint:disable-next-line: variable-name
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$1, mapDispatchToProps$1)(ControlledRepeat);
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      if (noOfJrCount > 0) {
        ...
        }, React.createElement(reactstrap.Label, null, fieldLabel), newFieldValue && // tslint:disable-next-line: variable-name
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$2, mapDispatchToProps$2)(UncontrolledRepeat);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (fieldElement.control && fieldElement.control['jr:count']) {
      return React.createElement(ConnectedUncontrolledRepeat, Object.assign({}, this.props));
    }

    return React.createElement(ConnectedControlledRepeat, Object.assign({}, this.props));
  };
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement("div", null, React.createElement(reactstrap.Input, {
        type: "hidden",
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$3, mapDispatchToProps$3)(Calculate);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement(reactstrap.FormGroup, null, React.createElement(reactstrap.Label, null, modifiedFieldLabel, ' ', isRequired && React.createElement("span", {
      ...
      }, REQUIRED_SYMBOL)), React.createElement(DatePicker, {
        ...
        className: "hintText"
      }, hintLabel), isFormSubmitted && isRequiredViolated && React.createElement(reactstrap.Label, {
        className: "requiredText"
      }, REQUIRED_FIELD_MSG), isConstraintViolated && React.createElement(reactstrap.Label, {
...
var ConnectedDate =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$4, mapDispatchToProps$4)(KbDate);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement(reactstrap.FormGroup, null, React.createElement(reactstrap.Label, null, modifiedFieldLabel, ' ', isRequired && React.createElement("span", {
        className: "requiredTextSteric"
      }, REQUIRED_SYMBOL)), React.createElement("br", null), React.createElement(DatePicker, {
        name: fieldElement.name,
        ...
        readOnly: isReadonly
      }), React.createElement("br", null), isFormSubmitted && isError && React.createElement(reactFontawesome.FontAwesomeIcon, {
        icon: "exclamation-circle",
        className: "errorSign"
      }), fieldElement.hint && React.createElement(reactstrap.Label, {
        className: "hintText"
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$5, mapDispatchToProps$5)(DateTime);
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$6, mapDispatchToProps$6)(Decimal);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, " ", fieldValue, " ")), React__default.createElement(reactstrap.Button, {
      size: "sm",
      color: "danger",
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$7, mapDispatchToProps$7)(FilePreview);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement(reactstrap.FormGroup, null, React.createElement(reactstrap.Label, null, modifiedFieldLabel, ' ', isRequired && React.createElement("span", {
        className: "requiredTextSteric"
      }, REQUIRED_SYMBOL)), fieldValue ? React.createElement(ConnectedFilePreview, {
        fieldName: fieldParentTreeName + fieldElement.name,
        fieldValue: fieldValue
      }) : fieldElement.type === PHOTO_FIELD_TYPE ? React.createElement(reactstrap.Input, {
        type: "file",
        accept: "image/*",
        name: fieldElement.name,
        onChange: this.onChangeHandler,
...
var ConnectedFile =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$8, mapDispatchToProps$8)(File);
...
var ConnectedText =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$9, mapDispatchToProps$9)(Text);
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$a, mapDispatchToProps$a)(AudioPreview);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement(reactstrap.FormGroup, null, React.createElement(reactstrap.Label, null, modifiedFieldLabel, ' ', isRequired && React.createElement("span", {
        className: "requiredTextSteric"
      }, REQUIRED_SYMBOL)), fieldValue ? React.createElement(ConnectedAudioPreview, {
        fieldName: fieldParentTreeName + fieldElement.name,
        fieldValue: fieldValue
      }) : React.createElement(reactstrap.Input, {
        type: "file",
...
var ConnectedAudio =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$b, mapDispatchToProps$b)(Audio);
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$c, mapDispatchToProps$c)(Integer);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      return React.createElement(reactstrap.FormGroup, null, React.createElement(reactstrap.Label, null, fieldLabel), isRequired && React.createElement(reactstrap.Label, {
        className: "requiredTextSteric"
      }, REQUIRED_SYMBOL), fieldElement.hint && React.createElement(reactstrap.FormText, {
        className: "hintText"
      }, fieldHint), isRequiredViolated && React.createElement(reactstrap.Label, {
        className: "requiredText"
      }, REQUIRED_FIELD_MSG), isConstraintViolated && React.createElement(reactstrap.Label, {
        className: "constraintText"
      }, modifiedConstraintLabel));
...
var ConnectedNote =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$d, mapDispatchToProps$d)(Note);
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$e, mapDispatchToProps$e)(SelectAllDropDown);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (isComponentRender) {
      ...
      var isError = isPresentInErrorSelector(fieldParentTreeName + fieldElement.name);
      return React.createElement("div", null, React.createElement(reactstrap.Label, null, modifiedFieldLabel, ' ', isRequired && React.createElement("span", {
        className: "requiredTextSteric"
      }, REQUIRED_SYMBOL)), React.createElement(reactstrap.Form, {
        key: "selectAll"
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$f, mapDispatchToProps$f)(SelectAllRadio);
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$g, mapDispatchToProps$g)(SelectOneDropDown);
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$h, mapDispatchToProps$h)(SelectOneRadio);
...
var ConnectedText$1 =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$i, mapDispatchToProps$i)(Text$1);
...
var ConnectedTime =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$j, mapDispatchToProps$j)(KbTime);
  ...
  _proto.typeEvaluator = function typeEvaluator(choices, csvList, fieldElement, fieldParentTreeName, defaultLanguage) {
    switch (fieldElement.type) {
      case TEXT_FIELD_TYPE:
        return React.createElement(ConnectedText$1, {
          fieldElement: fieldElement,
          fieldParentTreeName: fieldParentTreeName,
          defaultLanguage: defaultLanguage
        });
      ...
      case PHOTO_FIELD_TYPE:
        return React.createElement(ConnectedFile, {
          fieldElement: fieldElement,
          fieldParentTreeName: fieldParentTreeName,
          defaultLanguage: defaultLanguage
        });
      ...
      case AUDIO_FIELD_TYPE:
        return React.createElement(ConnectedAudio, {
          fieldElement: fieldElement,
          fieldParentTreeName: fieldParentTreeName,
          defaultLanguage: defaultLanguage
        });
  ...
  _proto.typeEvaluator = function typeEvaluator(choices, csvList, fieldElement, fieldParentTreeName, defaultLanguage) {
    switch (fieldElement.type) {
      ...
      case REPEAT_FIELD_TYPE:
        return React.createElement("div", null, React.createElement(Repeat, {
          choices: choices,
          fieldElement: fieldElement,
          fieldParentTreeName: fieldParentTreeName,
          defaultLanguage: defaultLanguage,
...
/*#__PURE__*/
reactRedux.connect(mapStateToProps$k)(GroupTypeEvaluator);

fontawesomeSvgCore.library.add(freeSolidSvgIcons.faPlusCircle, freeSolidSvgIcons.faMinusCircle, freeSolidSvgIcons.faExclamationCircle);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(reactstrap.Container, {
      ...
      defaultLanguage: defaultLanguage
    })), this.state && this.state.isSubmissionError && React.createElement(KbAlert, {
      color: 'danger',
...
var ConnectedApp =
/*#__PURE__*/
reactRedux.connect(mapStateToProps$l, mapDispatchToProps$k)(App);
